...
export default function LetterSection() {
  return (
    <section id="letter" className="py-16 md:py-24 max-w-4xl mx-auto px-6 relative">
      ...
      >
        {/* Oversized Quote SVG */}
        <svg className="absolute -top-2 -left-2 w-32 h-32 text-rose-light-accent opacity-35 select-none z-0 fill-current" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
        </svg>
        
        <blockquote className="relative z-10 font-cormorant italic text-[20px] md:text-[22px] font-light text-rose-dark-accent leading-[2.1] whitespace-pre-line">
        ...
        <div className="flex flex-col items-end mt-10 relative z-10 select-none">
          <div className="font-cormorant italic text-[18px] md:text-[20px] text-rose-medium-accent">
            — Yours, always
          </div>
